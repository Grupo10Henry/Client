  ...
  return (
      ...
      <div className="fixed inset-0 z-100 flex items-center justify-center backdrop-filter backdrop-blur-lg">
        ...
        {/* Contenedor principal del formulario */}
          ...
          <div className="sm:mx-auto sm:w-full sm:max-w-sm p-6 bg-white rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-1" action="#" method="POST">
            <div>
                <label className="block text-sm font-bold leading-6 text-gray-500">
                  Nombre:
                </label>
                <div className="mt-2">
                <input
            ...
            <button 
              ...
              <a
                    href="#"
                    className="font-semibold text-center-xs-teal-600 hover:text-fuchsia-600">
                    Ya estoy registrado
                  </a>
                  </div>
