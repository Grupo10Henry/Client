...
export default function AdminEventsCreate() {
  ...
  function handleSubmitCreateSection(e) {
    e.preventDefault()
    const repetido = sections.some(
      (existingSection) =>
        existingSection.sector.toLowerCase() === section.sector.toLowerCase()
    )
    if (repetido) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const [imageURL, bannerImageURL, planImageURL] = [
        imageResponse,
        bannerResponse,
        planResponse,
      ]
    ...
    <div className={styles.formContainer}>
      <form className={styles.form} onSubmit={handleSubmit}>
        <p className={styles.formTitle}>
          Completa la información para crear un evento
        </p>
        <div className={styles.formFields}>
          ...
          <div className={styles.formRows}>
            ...
            <div className={styles.fieldContainer}>
              <label className={styles.formLabel}>
                Ubicación en mapa {"("}Obtén link{" "}
                <a
                  className={styles.labelLink}
                  href="https://www.google.com/maps/@6.2477017,-75.5782726,11.79z?entry=ttu"
                  target="_blank"
      ...
      <form className={styles.sectionForm} onSubmit={handleSubmitCreateSection}>
        ...
        <p className={styles.sectionFormSubtitle}>
          Para crear una nueva sección, completa los campos y haz clic en
          "Añadir sección"
        </p>
        <div className={styles.formFields}>
          <div className={styles.formRows}>
        ...
        <button className={styles.sectionButton} type="submit">
          Añadir sección
        </button>
      </form>
      <div className={styles.sectionsTable}>
        ...
        {sections.length ? (
          <button className={styles.formButton} onClick={handlePostSections}>
            Agregar secciones a evento
          </button>
        ) : null}
        {sections.length ? (
          <button className={styles.formButton} onClick={deleteLastSection}>
            Eliminar sección
          </button>
        ) : null}
      </div>
